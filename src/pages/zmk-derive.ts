    ...
    <section class="mx-auto max-w-3xl p-6">
      ...
      <div class="grid gap-4">
        ...
        <section class="rounded-lg border border-line bg-surface p-4">
          <h2 class="font-semibold mb-4">Thales PayShield Trusted Management Device (TMD)</h2>
          <div class="grid gap-6">
            <div class="flex flex-col gap-2">
              <span class="text-sm text-muted">Exchange your derived ZMK to Thales TMD</span>
              <button data-testid="gen-csv" class="${btn} self-start" disabled>Generate MZMKdata CSV</button>
            </div>
            <div class="flex flex-col gap-2">
              <span class="text-sm text-muted">Derive the ZMK from Thales TMD</span>
              <label class="${btn} cursor-pointer text-center self-start">
                Import MZMKdata CSV
